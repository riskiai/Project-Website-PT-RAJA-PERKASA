  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>List Data Divisi PT Raja Perkasa</h4>
      </div>
      <div class="page-btn">
        <a href="{{ route('divisicreate') }}" class="btn btn-added">
          Tambah Data Divisi
        </a>
      </div>
    </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <form id="deleteForm-{{ $item->id }}" action="{{ route('ddivisidelete', ['id' => $item->id]) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
