              ...
              <div class="col-lg-6 col-sm-6 col-12">
                <div class="form-group">
                  ...
                  <select name="status_tentang" class="select">
                    <option value="active" {{ $data->status_tentang == 'active' ? 'selected' : '' }}>Active</option>
                    <option value="nonactive" {{ $data->status_tentang == 'nonactive' ? 'selected' : '' }}>In Active</option>
                  </select>
                </div>
              </div>
                ...
                <div class="form-group">
                    ...
                    <div class="mt-2">
                      @foreach(explode(',', $data->image) as $image)
                        <img src="{{ asset('storage/photo-tentangpt/' . $image) }}" alt="Image" width="100" class="img-thumbnail">
                      @endforeach
                    </div>
                  @endif
                </div>
