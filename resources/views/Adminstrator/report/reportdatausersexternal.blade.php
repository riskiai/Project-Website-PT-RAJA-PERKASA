...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('apply_filters').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('reportuserspicperusahaan') }}?${new URLSearchParams(filters).toString()}`;
    });

    // Reset filters
    document.getElementById('reset_filters').addEventListener('click', function () {
        sessionStorage.removeItem('filters');
        window.location.href = `{{ route('reportuserspicperusahaan') }}`;
    });
    ...
    document.getElementById('export_button').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('exportreportpicperusahaan') }}?${new URLSearchParams(filters).toString()}`;
    });
});
</script>
@endsection
