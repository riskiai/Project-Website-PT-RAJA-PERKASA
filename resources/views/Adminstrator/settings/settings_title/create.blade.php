    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Create Data Settings Title di PT Raja Perkasa</h4>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('settings_titlecreateproses') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                                <label>Title Judul Fitur Website</label>
                                <input type="text" name="title_nama" class="form-control" required />
                            </div>
                        </div>
                        <div class="col-lg-12">
