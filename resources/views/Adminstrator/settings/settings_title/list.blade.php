        ...
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="{{ route('settings_titlecreate') }}" class="btn btn-added">
                    <img src="{{ asset('assets/img/icons/plus.svg') }}" class="me-2" alt="img"/>Tambah Data Setting
                </a>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table datanew">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Title Judul Fitur Website</th>
                                <th>Created Date</th>
                                <th>Updated Date</th>
                                <th>Action</th>
                            </tr>
