          ...
          <li class="nav-item dropdown has-arrow main-drop">
              <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                  <span class="user-img">
                      @if(auth()->user()->role->role_name == 'admin')
                          <img src="{{ auth()->user()->file_foto ? asset('storage/client/photo-profile/' . auth()->user()->file_foto) : asset('assets/img/customer/customer5.jpg') }}" alt="img" id="blah" />
                      @else
              ...
              <div class="dropdown-menu menu-drop-user">
                  <div class="profilename">
                      ...
                      <hr class="m-0" />
                      <a class="dropdown-item" href="{{ route('editusersprofile', auth()->user()->id) }}">
