...
<div class="page-wrapper">
    <div class="content">
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('updateusersprofile', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
              ...
              <div class="profile-top">
                <div class="profile-content">
                  <div class="profile-contentimg">
                    <img
                      src="{{ $user->file_foto ? asset('storage/client/photo-profile/' . $user->file_foto) : asset('assets/img/customer/customer5.jpg') }}"
                      alt="img"
                      id="blah"
                    />
