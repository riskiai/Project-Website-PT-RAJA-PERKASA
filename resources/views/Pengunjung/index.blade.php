        ...
        <div class="row g-0 service-row">
            ...
            <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                <div class="service-item border h-100 p-5">
                    ...
                    <p class="mb-4">PT Raja Perkasa menyediakan layanan konsultasi proyek profesional dan terpercaya. Tim ahli kami membantu mengelola proyek konstruksi dengan baik.</p>
                    <a class="btn" href="{{ route('jasalink') }}"><i class="fa fa-arrow-right text-white me-3"></i>Baca Selengkapnya</a>
                </div>
            </div>
        </div>
