    ...
    <div class="content">
      <div class="page-header">
        <div class="page-title">
          <h4>Profile Role Karyawan PT Raja Perkasa</h4>
          <h6>
            @foreach($karyawanUsers as $karyawan)
              {{ $karyawan->name }}@if(!$loop->last), @endif
            @endforeach
          </h6>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <form action="{{ route('updatekaryawanprofile', $user->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('POST')
              ...
              <div class="profile-top">
                <div class="profile-content">
                  <div class="profile-contentimg">
                    <img
                      src="{{ $user->file_foto ? asset('storage/karyawan/photo-profile/' . $user->file_foto) : asset('assets/img/customer/customer5.jpg') }}"
                      alt="img"
                      id="blah"
                    />
