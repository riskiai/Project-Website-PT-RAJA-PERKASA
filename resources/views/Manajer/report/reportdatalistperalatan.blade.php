        ...
        <div class="table-top">
          ...
          <div class="wordset">
            <ul>
              ...
              <li>
                <a href="{{ route('exportreportlistperalatan') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="excel">
          ...
          <table class="table datanew text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                {{-- <td>
                  <a class="me-3" href="{{ route('listdataperalatanedit', $item->id) }}">
                    <img src="{{ asset('assets/img/icons/edit.svg') }}" alt="img" />
                  </a>
                  <a class="me-3" href="{{ route('showlistdataperalatans', ['id' => $item->id]) }}" title="Melihat Data Detail Peralatan">
                    <i class="fas fa-eye text-dark"></i>
                  </a>
                  <button type="button" class="btn btn-link text-dark btn-delete" data-id="{{ $item->id }}" title="Menghapus Data">
                    <img src="{{ asset('assets/img/icons/delete.svg') }}" alt="img" />
                  </button>
                  <form id="deleteForm-{{ $item->id }}" action="{{ route('listdataperalatandelete', $item->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
                  </form>
                </td> --}}
