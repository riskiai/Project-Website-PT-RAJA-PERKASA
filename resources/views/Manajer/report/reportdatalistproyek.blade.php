...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('apply_filters').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('reportlistproyek') }}?${new URLSearchParams(filters).toString()}`;
    });

    // Reset filters
    document.getElementById('reset_filters').addEventListener('click', function () {
        sessionStorage.removeItem('filters');
        window.location.href = `{{ route('reportlistproyek') }}`;
    });
    ...
    document.getElementById('export_button').addEventListener('click', function () {
        ...
        window.location.href = `{{ route('exportreportlistproyek') }}?${new URLSearchParams(filters).toString()}`;
    });
});
</script>
@endsection
