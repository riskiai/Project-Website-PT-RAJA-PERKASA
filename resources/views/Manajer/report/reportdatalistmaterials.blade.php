  ...
  <div class="content">
    <div class="page-header">
      <div class="page-title">
        <h4>List Data Materials PT Raja Perkasa</h4>
      </div>
      {{-- <div class="page-btn">
        <a href="{{ route('listdatamaterialscreate') }}" class="btn btn-added">
          Tambah Data Materials
        </a>
      </div> --}}
    </div>
        ...
        <div class="table-top">
          ...
          <div class="wordset">
              <ul>
                  ...
                  <li>
                      <a href="{{ route('exportreportlistmaterials') }}" data-bs-toggle="tooltip" data-bs-placement="top" title="excel">
            ...
            <tbody>
              ...
              <tr>
                ...
                {{-- <td>
                  ...
                  <a class="me-3" href="{{ route('showlistdatamaterials', ['id' => $item->id]) }}" title="Melihat Data Detail List Materials">
                    <i class="fas fa-eye text-dark"></i>
                  </a>
                  <button type="button" class="btn btn-link text-dark btn-delete" data-id="{{ $item->id }}" title="Menghapus Data">
                    <img src="{{ asset('assets/img/icons/delete.svg') }}" alt="img" />
                  </button>
                  <form id="deleteForm-{{ $item->id }}" action="{{ route('listdatamaterialsdelete', $item->id) }}" method="POST" style="display: none;">
                    @csrf
                    @method('DELETE')
