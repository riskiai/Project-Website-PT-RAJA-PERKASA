                    ...
                    <div class="col-lg-6 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <select name="status_progres_proyek" class="select" required>
                                <option value="Perencanaan" {{ old('status_progres_proyek', $proyek->status_progres_proyek) == 'Perencanaan' ? 'selected' : '' }}>Perencanaan</option>
                                <option value="SedangBerlangsung" {{ old('status_progres_proyek', $proyek->status_progres_proyek) == 'SedangBerlangsung' ? 'selected' : '' }}>Sedang Berlangsung</option>
                                <option value="Penyelesaian" {{ old('status_progres_proyek', $proyek->status_progres_proyek) == 'Penyelesaian' ? 'selected' : '' }}>Penyelesaian</option>
                                <option value="Pemeliharaan" {{ old('status_progres_proyek', $proyek->status_progres_proyek) == 'Pemeliharaan' ? 'selected' : '' }}>Pemeliharaan</option>
                            </select>
